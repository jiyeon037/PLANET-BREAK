...
public class Inventory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        inventoryItemList.Add(new Item(10001, "빨간 포션", "HP를 5 채워주는 물약", Item.ItemType.Use, 20));
        inventoryItemList.Add(new Item(10002, "농축 빨간 포션", "HP를 모두 채워주는 강력한 물약", Item.ItemType.Use, 5));
